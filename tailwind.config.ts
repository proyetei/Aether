...
const config = {
  ...
  content: [
    ...
    "./app/**/*.{ts,tsx}",
    "./src/**/*.{ts,tsx}",
    "./node_modules/@nextui-org/theme/dist/components/(card|modal|spinner|ripple).js"
  ],
  prefix: "",
  theme: {
    container: {
    ...
    extend: {
      ...
      boxShadow: {
        't-sm': '0 -1px 10px 0 rgba(255, 255, 255, 0.05)',
        't-md': '0 -4px 20px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)',
        't-lg': '0 -10px 30px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
        't-xl': '0 -20px 40px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
        't-2xl': '0 -25px 60px -12px rgba(0, 0, 0, 0.25)',
        't-3xl': '0 -35px 70px -15px rgba(0, 0, 0, 0.3)',
  ...
  plugins: [require("tailwindcss-animate"), require("tailwindcss-animated"),nextui()]
} satisfies Config
