...
const PointsUI: React.FC<PointsUIProps> = ({ totalPoints, currentLevel, nextLevel, progressPercentage }) => {
  return (
    <div className="bg-gradient-to-r from-blue-600 via-blue-400 to-pink-400 rounded-2xl md:p-6 p-4 w-64 shadow-md">
      ...
      <div className="mt-4 text-left md:text-md text-sm">Current level</div>
      <div className="relative">
        ...
        <div className="h-4 rounded-full bg-gray-300 mt-1 relative overflow-hidden">
          <div className="h-full rounded-full bg-pink-600 absolute left-0 top-0" style={{ width: `${progressPercentage}%` }}></div>
        </div>
      </div>
    </div>
  );
