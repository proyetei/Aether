...
export default function MobileMarketing(){
    return(
        ...
        <div className=" flex flex-col md:flex-row p-4 text-center">
            ...
            <p className={`text-slate-300 ${poppins.className} text-sm`}> Bored while traveling? Need an outlet for your thoughts? Have Aether by your side whenever and wherever</p>
            <p className={`text-slate-300 ${poppins.className} text-sm`}>Set notifications to remind you to complete your tasks</p>
            <div className="flex flex-row gap-8">
                ...
                <button className="px-2 py-2 text-sm text-white transition duration-300 ease-in-out delay-100 skew-y-3 bg-purple-600 border-b-4 border-purple-800 rounded shadow-lg shadow-purple-600/50 hover:skew-x-6 hover:border-purple-600">
                    <div className="flex flex-row gap-2 items-center justify-center">
                    <FaGooglePlay />
