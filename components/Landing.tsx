...
export default function Landing() {
  return (
      <div className=" flex flex-row w-3/4 gap-2 items-center rounded-lg relative z-10">
        <motion.div
          viewport={{ once: true }}
          whileInView="show"
          initial="hidden"
        ...
        >
          <div className="flex flex-row gap-4 items-center justify-center drop-shadow-blue">
            <Image src="/aether-bot.svg" alt="Aether bot" height={80} width={80} />
        ...
        {/* <Image src="/journal-anime-girl.png" alt="girl" width={600} height={500}/> */}
        </motion.div>
      </div>
  )
}
